...
public class FilterDispatcher implements Filter {
    ...
    public FilterDispatcher() {
        ...
        STUDENT.add("submit");
        STUDENT.add("history");
        STUDENT.add("viewResult");
        STUDENT.add("viewHistory");
        STUDENT.add("viewHistoryDetail");
        STUDENT.add("");
            ...
            if (url != null) {
                ...
                if(session == null || session.getAttribute("EMAIL") == null){
                    ...
                    if(AD.equals(roleID) && ADMIN.contains(resource)){
                        RequestDispatcher rd = req.getRequestDispatcher(url);
                        rd.forward(request, response);
                    }else if(ST.equals(roleID) && STUDENT.contains(resource)){
                        RequestDispatcher rd = req.getRequestDispatcher(url);
                        rd.forward(request, response);
                    }else{
                        if(AD.equals(roleID)) res.sendRedirect("adminPage");
                        else{
