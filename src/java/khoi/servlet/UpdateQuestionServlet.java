...
public class UpdateQuestionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            QuestionDTO dto = dao.GetQuestion(questionID);
            QuestionChoiceDAO cdao = new QuestionChoiceDAO();
            cdao.getQuestionChoice(questionID);
            List<QuestionChoiceDTO> result = cdao.getListChoice();
            HttpSession session = request.getSession();
            session.setAttribute("question", dto);
            session.setAttribute("result", result);
        } catch (SQLException | NamingException | NumberFormatException e) {
           Logger.getLogger(UpdateQuestionServlet.class).error("Error at UpdateQuestionServlet " + e.toString());
        } finally {
